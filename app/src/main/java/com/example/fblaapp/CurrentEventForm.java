...
public class CurrentEventForm extends AppCompatActivity {
    ...
    /**
     * opens the congratulations page after submission
     * @param view view that uses this function
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_event_form);
    }
